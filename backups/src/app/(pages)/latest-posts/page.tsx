    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-12">
        {Array.from(new Set(articles.flatMap(article => article.categories))).map((category) => (
          <button
            key={category}
            className="px-6 py-2 rounded-full border border-primary-200 text-primary-600 hover:bg-primary-50 transition-colors"
          >
            {category}
          </button>
        ))}
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="flex-1 px-6 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-transparent"
            />
            <button
              type="submit"

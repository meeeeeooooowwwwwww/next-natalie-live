        ...
        <div className="border-t border-gray-200 pt-8 mb-12">
          <div className="bg-gray-100 rounded-lg p-6">
            ...
            <div className="mt-6 flex gap-4 border-t border-gray-300 pt-4">
              <a href="https://twitter.com/intent/tweet" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary-600 transition-colors">
                <FaTwitter size={24} />
              </a>
              <a href="https://www.facebook.com/sharer/sharer.php" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary-600 transition-colors">
                <FaFacebook size={24} />
              </a>
              <a href="https://www.linkedin.com/sharing/share-offsite/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary-600 transition-colors">
                <FaLinkedin size={24} />
              </a>
              <a href="mailto:" className="text-gray-600 hover:text-primary-600 transition-colors">
                <FaEnvelope size={24} />
              </a>
            </div>
          </div>

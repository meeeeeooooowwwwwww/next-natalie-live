          ...
          {timelineEvents.map((event) => (
            <div key={event.id} className="relative">
              ...
              <div className="flex flex-col relative pl-8">
                <div className="absolute left-0 top-0 w-4 h-4 bg-pink-400 rounded-full transform -translate-x-1/2" />
                <div className="absolute left-0 top-4 bottom-0 w-0.5 bg-gray-300 transform -translate-x-1/2" />
